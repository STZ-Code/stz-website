		...
		<>
			...
			<div className="bg-cover bg-center justify-center">
				...
				>
					<div className="flex bg-cover bg-center flex-col gap-12 justify-center px-12 h-screen">
						<h1 className="text-slate-900 text-7xl font-medium w-2/3">
							Solucionando seu Problema com Tecnologia
						</h1>

						<button
							type="button"
							className="bg-slate-800 text-slate-50 rounded-xl w-fit text-2xl px-12 py-6"
						>
							Quero minha solução
						</button>
					</div>
				...
				<div className="flex flex-col items-center justify-center gap-12 w-full px-24 h-full">
					<div className="flex flex-col items-center gap-6 px-24">
						...
						<p className="text-center text-slate-800">
							Explore nosso portfólio e veja como transformamos ideias em
							soluções reais. <br />
							Da web ao mobile, cada entrega é feita com excelência e foco no
							resultado. <br />
							Aqui você encontra exemplos concretos do que podemos construir
							para sua empresa.
						</p>
					</div>
			...
			<div className="min-h-screen px-12 mt-8 flex flex-col py-12 bg-[linear-gradient(180deg,rgba(226,232,240,0)_0%,#E2E8F0_8%,#E2E8F0_92%,rgba(226,232,240,0)_100%)]">
				...
				<div className="flex gap-6 mt-4">
					<div className="w-1/2">
						<h3 className="text-slate-900 font-medium text-5xl w-1/2 mt-2 mb-12">
						...
						<p className="text-slate-800 text-xl mb-14">
							...
							<br />
							Na STZCODE, unimos experiência e inovação para entregar soluções
